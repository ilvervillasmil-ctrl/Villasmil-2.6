...
def distribute_action(
    ...
    """Reparte la carga para que ninguna capa sufra el impacto sola."""
    ...
    raw = {k: base_effort * w for k, w in weights.items()}
...
def simulate_apply(current_R: float, effort: Dict[str, float]) -> SimulatedOutcome:
    """Modelo de beneficio saturable y coste cuadrático."""
...
def should_apply(
    ...
    """Evalúa si el empuje extra justifica el riesgo."""
    ...
    # Aplicar soft si el coste es bajo y la ganancia marginal no es disruptiva
...
def detect_respiro(
    ...
    """El éxito es la autorregulación sin intervención."""
